...
export const ProductsTable = () => {
    ...
    const createColumnsDefs = () => {
        const columns = ['id', 'name', 'price', 'stock', 'isActive', 'imageCover', 'imageHover'];
    ...
    const handleSaveInContextClick = (event) => {
        ...
        for (const row of sortedRows) {
            sortedProducts.push(products.find(product => product.id === Number(row.id)))
        }
    ...
    return (
        <div className="ag-theme-alpine" style={{height: '100vh', width: '100vh'}}>
